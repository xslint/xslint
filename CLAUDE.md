...
reading #783's index has given here, 6.05%, and a **sixth** below the cheapest
...
tighten by a ninth as a side effect of a stage they have nothing to do with. The
entry read 26 while the scan was what the gate had to hold, drawn a tenth above
the dearest reading that scan gave on any runner and a fortieth below the
cheapest #755's quadratic gave here, on CI evidence rather than caution — this
is the entry a runner disagrees about most, four of them charging the scan
14.4%, 19.1%, 22.0% and 23.5% of the run where this machine charged 15.4%.
...
which is the stronger statement; those sixteen read 0.19 to 1.35, against a
