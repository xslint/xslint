...
which the sixteen of them sit far below at 0.18% to 2.44% — so a cheap stage
...
and a simplified stylesheet has neither half. The widening admits any of the
nineteen names under that namespace rather than the one, since a prefix is the
