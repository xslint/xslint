...
const FILTERED = [
  ...
  {xpath: 'a/b/number(.)', filters: false},
  {xpath: '@a/number(.)', filters: false},
  {xpath: 'a/string-length(.)', filters: false},
  {xpath: 'descendant::a/count(.)', filters: false},
  {xpath: 'a/(count(.))', filters: false},
  {xpath: 'a/fn:count(.)', filters: false},
  {xpath: 'a/count(.)[1]', filters: false},
  {xpath: 'a/b[@c]', filters: true},
  {xpath: 'a/not(@b)', filters: true},
  {xpath: 'a | b', filters: true},
