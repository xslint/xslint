 ...
 * reads 139,643, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 21,572 for `src/linters/CLAUDE.md`, where half of the bar
 * is 75,000 — and holds the root itself to 85,468, a number derived from the
 ...
 * 357 characters of headroom, off a chain that is `src/linters/`'s own once
