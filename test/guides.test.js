 ...
 * reads 139,519, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 21,696 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 481 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 2,483 characters out of every chain through `test/`
