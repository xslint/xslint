 ...
 * reads 139,045, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 22,170 for `src/linters/CLAUDE.md`, where half of the bar
 * is 75,000 — and holds the root itself to 86,066, a number derived from the
 ...
 * 955 characters of headroom, off a chain that is `src/linters/`'s own once
