 ...
 * reads 139,345, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 21,870 for `src/linters/CLAUDE.md`, where half of the bar
 * is 75,000 — and holds the root itself to 86,726, a number derived from the
 ...
 * 655 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 2,566 characters out of every chain through `test/`
