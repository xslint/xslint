 ...
 * reads 139,236, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 21,979 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 764 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 2,654 characters out of every chain through `test/`
