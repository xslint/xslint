 ...
 * reads 138,121, which is 0.92, and is `src/linters/`'s once more. What
 ...
 * stands over it — 23,094 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 1,879 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 4,144 characters out of every chain through `test/`
