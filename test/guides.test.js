 ...
 * reads 139,468, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 21,747 for `src/linters/CLAUDE.md`, where half of the bar
 * is 75,000 — and holds the root itself to 85,643, a number derived from the
 ...
 * 532 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 3,526 characters out of every chain through `test/`
