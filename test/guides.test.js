 ...
 * reads 139,579, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 23,849 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 421 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 4,899 characters out of every chain through `test/`
