 ...
 * reads 139,666, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 21,549 for `src/linters/CLAUDE.md`, where half of the bar
 * is 75,000 — and holds the root itself to 86,635, a number derived from the
 ...
 * 334 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 2,336 characters out of every chain through `test/`
