 ...
 * reads 139,441, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 23,987 for `src/linters/CLAUDE.md`, where half of the bar
 * is 75,000 — and holds the root itself to 84,204, a number derived from the
 ...
 * 559 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 4,992 characters out of every chain through `test/`
