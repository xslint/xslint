 ...
 * reads 138,739, which is 0.92, and is `src/linters/`'s once more. What
 ...
 * stands over it — 22,476 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 1,261 characters of headroom, off a chain that is `src/linters/`'s own once
