 ...
 * reads 139,407, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 21,808 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 593 characters of headroom, off a chain that is `src/linters/`'s own once
