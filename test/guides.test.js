 ...
 * reads 139,308, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 21,907 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 692 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 2,582 characters out of every chain through `test/`
