 ...
 * reads 139,736, which is 0.93, and is `src/linters/`'s once more. What
 ...
 * stands over it — 23,692 for `src/linters/CLAUDE.md`, where half of the bar
 ...
 * 264 characters of headroom, off a chain that is `src/linters/`'s own once
 ...
 * of this file behind it, 4,742 characters out of every chain through `test/`
