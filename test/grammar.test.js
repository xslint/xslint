...
const REFUSES = [
  ...
  {name: 'a prefix with nothing behind it', xpath: 'a:', at: 0},
  {name: 'a variable named by a bare prefix', xpath: '$my:', at: 1},
  {name: 'a call named by a bare prefix', xpath: 'my:(1)', at: 0},
  ...
  {name: 'a two-character word operator run against a number', xpath: '1eq 2',
    at: 1},
  {name: 'a wildcard whose prefix a gap follows', xpath: 'my: *', at: 0},
