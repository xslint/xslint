...
`src/syntax.js` — 24,681 characters — and the dearest chain is that same one at 141,541, which is
...
other guide against the bar less what stands over it — 35,030 for `src/linters/CLAUDE.md`, where
