...
`src/syntax.js` — 24,681 characters — and the dearest chain is that same one at 142,429, which is
0.95. What answers a chain reaching the bar is that move again, a module's derivation into the
...
half of the bar is 75,000 — and holds the root itself to 76,300, a number derived from the dearest
