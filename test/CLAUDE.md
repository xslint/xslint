...
`src/syntax.js` — 24,681 characters — and the dearest chain is that same one at 136,314, which is
...
other guide against the bar less what stands over it — 40,257 for `src/linters/CLAUDE.md`, where
