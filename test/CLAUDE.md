...
`src/syntax.js` — 24,681 characters — and the dearest chain is that same one at 148,894, which is
...
other guide against the bar less what stands over it — 33,104 for `src/linters/CLAUDE.md`, where
