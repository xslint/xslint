...
`src/syntax.js` — 24,681 characters — and the dearest chain is that same one at 135,761, which is
...
other guide against the bar less what stands over it — 40,810 for `src/linters/CLAUDE.md`, where
